...
static int parse_mac(char *str, unsigned char mac[ETH_ALEN]) {
  ...
  if (6 == sscanf(str, "%hhx:%hhx:%hhx:%hhx:%hhx:%hhx", &mac[0], &mac[1],
...
int main(int argc, char **argv) {
  ...
  /* Assignment 3: open the tx_port map corresponding to the cfg.ifname
   * interface */
  ...
  if (redirect_map) {
    ...
    /* Assignment 3: open the redirect_params map corresponding to the
